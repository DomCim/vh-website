...
const TEXTE: Record<Locale, Absatz> = {
  de: {
    ...
    text: [
      'Wir zählen, wie oft unsere Seiten aufgerufen werden. Dafür setzen wir Plausible ein — eine Software, die auf einem Server läuft, den wir selbst betreiben. Die Daten bleiben dort; sie werden nicht an Dritte weitergegeben und nicht mit anderen Diensten geteilt.',
  ...
  fr: {
    ...
    text: [
      "Nous comptons le nombre de consultations de nos pages. Pour cela, nous utilisons Plausible, un logiciel installé sur un serveur que nous exploitons nous-mêmes. Les données y restent : elles ne sont ni transmises à des tiers ni partagées avec d'autres services.",
  ...
  en: {
    ...
    text: [
      'We count how often our pages are viewed. For this we use Plausible, software that runs on a server we operate ourselves. The data stays there: it is not passed on to third parties and not shared with other services.',
