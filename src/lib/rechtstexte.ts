...
function versandZahlung(sprache: Sprache): string {
  ...
  if (sprache === 'en') {
    return [
      ...
      'Payment',
      'Payment is handled by PayPal — with a PayPal account, a card or direct debit; a PayPal account is not required. Towards us the full amount is due when you order; production starts once payment has arrived. Whether PayPal additionally offers you deferred payment or instalments is PayPal\'s decision — that is an agreement between you and PayPal and does not affect our claim.',
      'Prices',
  ...
  return [
    ...
    'Zahlung',
    'Bezahlt wird über PayPal — mit PayPal-Konto, Karte oder Lastschrift; ein PayPal-Konto ist dafür nicht nötig. Uns gegenüber ist der volle Betrag mit der Bestellung fällig; gefertigt wird nach Zahlungseingang. Ob PayPal Ihnen darüber hinaus ein späteres Zahlungsziel oder eine Ratenzahlung anbietet, entscheidet PayPal — das ist eine Vereinbarung zwischen Ihnen und PayPal, auf unsere Forderung wirkt sie sich nicht aus.',
    'Preise',
