...
export const LEITPLANKEN: string[] = [
  ...
  '',
  '**Ein Artikel mit Varianten** braucht Titel und Variantenbezeichnungen in',
  'einem einzigen produkt_aendern-Aufruf, sonst weist Payload beides ab. Die',
  'Kennung jeder Variante aus produkt_lesen mitgeben — daran hängen Stückliste,',
