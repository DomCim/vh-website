...
export const LEITPLANKEN: string[] = [
  ...
  '',
  '## Übersetzen',
  'Fünf Regeln, jede aus einem Schaden gelernt:',
  '',
  '**Die Gliederung des Originals übernehmen.** Fließtext versteht',
  '`## Überschrift`, `### kleinere`, `- Aufzählung` und `**fett**`. Hat der',
  'deutsche Text Zwischenüberschriften, muss der französische sie auch haben —',
  'sonst steht neben einem gegliederten Text eine Textwüste. Die Gliederung ist',
  'kein Schmuck: Daran orientiert sich der Leser, und daran erkennt Google,',
  'worum es geht.',
  '',
  '**Gefüllt ist nicht übersetzt.** Wo 250 Zeichen stehen und im Deutschen',
  '2.300, ist das ein Rest aus früherer Zeit und keine Übersetzung.',
  'uebersetzungen_pruefen meldet so etwas als „auffällig".',
  '',
  '**Vor dem Schreiben das Original lesen** — mit *_lesen und sprache: "de".',
  'Nicht aus dem Gedächtnis übersetzen und nicht aus der Liste, die kürzt.',
  '',
  '**Nicht übersetzt werden** Marken- und Fachbegriffe: NEXT CONCEPT, FLAMINGO,',
  'Cimatron, Brasero, Corten/Cortenstahl, RAL-Bezeichnungen, Vincent Hellmann,',
  'Next-Concept SAS. Flammkuchen heißt auf Französisch flammekueche oder tarte',
  'flambée, auf Englisch tarte flambée.',
  '',
  '**Ein Artikel mit Varianten oder Farboptionen** braucht Titel,',
  'Variantenbezeichnungen und Farbnamen in einem einzigen',
  'produkt_aendern-Aufruf, sonst weist Payload alles ab: Beim Anlegen einer',
  'Sprachfassung prüft Payload das ganze Dokument, und diese drei sind zugleich',
  'Pflicht und übersetzbar. Die Kennung jeder Variante und jeder Farbe aus',
  'produkt_lesen mitgeben — an der Variante hängen Stückliste,',
  'Werkstattdateien und die Bestellungen, an der Farbe ihr Bild.',
  '',
  '## Adressen',
  'Eine Adresse ist ein Versprechen: Sie steht in Lesezeichen, in Mails und im',
  'Index von Google. Sie wird nicht geändert, weil ein besserer Name einfiel.',
  'Wenn doch, dann über **adresse_setzen** — dann entsteht die Umleitung von',
  'der alten Adresse automatisch, und niemand landet im Nichts. Was in der',
  'jeweiligen Sprache noch die deutsche Adresse trägt, zeigt adressen_pruefen.',
  '',
