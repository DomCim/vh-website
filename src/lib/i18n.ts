...
const de = {
  ...
  marke: {
    title: 'Laufmarke',
    /* Mehr sagt die Seite ohne Anmeldung nicht — wer den Code abfotografiert,
       erfährt weder Auftrag noch Kunde. */
    intro: 'Diese Marke gehört zu einem Auftrag der Werkstatt Hellmann.',
    pinLabel: 'PIN Ihres Betriebs',
    pinHint: 'Sie haben den PIN von der Werkstatt Hellmann bekommen. Einmal eingeben genügt — dieses Gerät merkt ihn sich.',
    open: 'Anmelden',
    opening: 'wird geprüft …',
    denied: 'Der PIN stimmt nicht — oder diese Marke gehört zu keinem Auftrag für Ihren Betrieb.',
    tooMany: 'Zu viele Versuche. Bitte in einer Viertelstunde erneut probieren.',
    office: 'Werkstatt Hellmann? Hier anmelden.',
    step: 'Ihr Arbeitsschritt',
    due: 'Gewünscht zurück bis',
    qty: 'Menge',
    color: 'Farbe',
    arrived: 'Teil ist bei uns angekommen',
    arrivedAt: 'Angekommen gemeldet am',
    done: 'Fertig — kann abgeholt werden',
    doneAt: 'Fertig gemeldet am',
    error: 'Das hat nicht geklappt. Bitte erneut versuchen.',
  },
  downloads: {
    title: 'Ihre Dateien',
...
const fr: Dictionary = {
  ...
  marke: {
    ...
    intro: "Cette étiquette appartient à une commande de l'atelier Hellmann.",
    pinLabel: 'Code PIN de votre entreprise',
    pinHint: "Vous avez reçu le code PIN de l'atelier Hellmann. Une seule saisie suffit — cet appareil le retient.",
    open: 'Se connecter',
    opening: 'vérification …',
    denied: "Le code PIN ne correspond pas — ou cette étiquette n'appartient à aucune commande pour votre entreprise.",
    tooMany: "Trop de tentatives. Merci de réessayer dans un quart d'heure.",
    office: 'Atelier Hellmann ? Connectez-vous ici.',
    step: 'Votre étape de travail',
    due: 'Retour souhaité avant le',
    qty: 'Quantité',
    color: 'Couleur',
    arrived: 'La pièce est arrivée chez nous',
    arrivedAt: 'Arrivée signalée le',
    done: 'Terminé — prêt à être enlevé',
    doneAt: 'Terminé signalé le',
    error: "Cela n'a pas fonctionné. Merci de réessayer.",
  },
  downloads: {
    title: 'Vos fichiers',
...
const en: Dictionary = {
  ...
  marke: {
    title: 'Tracking tag',
    intro: 'This tag belongs to an order of the Hellmann workshop.',
    pinLabel: 'Your company PIN',
    pinHint: 'You received the PIN from the Hellmann workshop. Enter it once — this device remembers it.',
    open: 'Sign in',
    opening: 'checking …',
    denied: 'The PIN does not match — or this tag does not belong to an order for your company.',
    tooMany: 'Too many attempts. Please try again in fifteen minutes.',
    office: 'Hellmann workshop? Sign in here.',
    step: 'Your work step',
    due: 'Requested back by',
    qty: 'Quantity',
    color: 'Colour',
    arrived: 'The part has arrived',
    arrivedAt: 'Arrival reported on',
    done: 'Finished — ready for pickup',
    doneAt: 'Finished reported on',
    error: 'That did not work. Please try again.',
  },
  downloads: {
    title: 'Your files',
