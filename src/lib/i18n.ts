...
const de = {
  ...
  product: {
    ...
    color: 'Farbe',
    from: 'ab',
    priceNote: 'inkl. MwSt., zzgl. Lieferung',
  ...
  cart: {
    ...
    priceNote: 'Preise inkl. MwSt. Lieferkosten werden nach Bestelleingang abgestimmt.',
  },
  checkout: {
    title: 'Kasse',
...
const fr: Dictionary = {
  ...
  product: {
    ...
    color: 'Couleur',
    from: 'à partir de',
    priceNote: 'TVA incluse, hors livraison',
  ...
  cart: {
    ...
    priceNote: 'Prix TTC. Les frais de livraison seront convenus après la commande.',
  },
  checkout: {
    title: 'Caisse',
