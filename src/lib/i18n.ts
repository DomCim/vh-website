...
const de = {
  ...
  marke: {
    ...
    intro: 'Diese Marke gehört zu einem Auftrag von Next-Concept SAS.',
    pinLabel: 'PIN Ihres Betriebs',
    pinHint: 'Sie haben den PIN von Next-Concept SAS bekommen. Einmal eingeben genügt — dieses Gerät merkt ihn sich.',
    open: 'Anmelden',
    opening: 'wird geprüft …',
    denied: 'Der PIN stimmt nicht — oder diese Marke gehört zu keinem Auftrag für Ihren Betrieb.',
    tooMany: 'Zu viele Versuche. Bitte in einer Viertelstunde erneut probieren.',
    office: 'Next-Concept SAS? Hier anmelden.',
...
const fr: Dictionary = {
  ...
  marke: {
    ...
    intro: "Cette étiquette appartient à une commande de Next-Concept SAS.",
    pinLabel: 'Code PIN de votre entreprise',
    pinHint: "Vous avez reçu le code PIN de Next-Concept SAS. Une seule saisie suffit — cet appareil le retient.",
    open: 'Se connecter',
    ...
    tooMany: "Trop de tentatives. Merci de réessayer dans un quart d'heure.",
    office: 'Next-Concept SAS ? Connectez-vous ici.',
...
const en: Dictionary = {
  ...
  marke: {
    title: 'Tracking tag',
    intro: 'This tag belongs to an order of Next-Concept SAS.',
    pinLabel: 'Your company PIN',
    pinHint: 'You received the PIN from Next-Concept SAS. Enter it once — this device remembers it.',
    open: 'Sign in',
    opening: 'checking …',
    denied: 'The PIN does not match — or this tag does not belong to an order for your company.',
    tooMany: 'Too many attempts. Please try again in fifteen minutes.',
    office: 'Next-Concept SAS? Sign in here.',
    step: 'Your work step',
